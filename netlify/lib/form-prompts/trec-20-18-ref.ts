// Extracted from form-prompts/trec_20-18_ref.pdf via pdf-parse.
// Regenerate with: node scripts/extract-ref-text.mjs

export const TREC_20_18_REF_TEXT = `

Initialed for identification by Buyer      and Seller    TREC NO. 20-18[17] 
 Contract Concerning  Page   of 11   11-04-2024
[11-07-2022] (Address of Property)    
PROMULGA
TED BY THE TEXAS REAL ESTATE COMMISSION (TREC) 
...
below.
2. PROPER
TY: The land, improvements and accessories are collectively referred to as the Property
(Property).
A.
LAND: Lot                     Block         
 ,
...
above-described   real   property,   including   without   limitation,   the   following   perman
ently
install
ed   and   built-in   items,  if  any:  all  equipment  and  appliances,  valances,  
screens,
shutters, awnings, wall-to-wall carpeting, mirrors, ceiling fans, attic fans, mail boxes, television
antennas, 
mounts and brackets for televisions and speakers, heating and air-conditioning unit
s,
security and fire detecti
on equipment, wiring, plumbing and lighting fixtures, chandelie
rs, water
softener  system,  
kitchen  equipment,  garage  door  openers,  cleaning  equipment,  shrubbery,
...
units,  stove,  fireplace  screens,  curtains  and  rods,  blinds,  window  sha
des,  draperies  and  rods,
...
improvements  or  accessories,  and  (ii)  hardware  used  solely  to  control  improvements
  or
accessories.
D
. EXCLUSIONS:  The  following  improvements  and  accessories  will    be    retained    by    Seller    an
d
...
in
terests is made in accordance with an attached addendum
.
3. SALE
S PRICE:
...
Property. After the 
Effective Date, Seller may not, without Buyer's written consent, create a new
...
mineral,        geothermal,  water,  wind,  or  other  natural  resource  lease  affecting  the  
Property  to
...
 Seller’s  Buyer’s expense an owner policy of  
...
or T-47.1 Declaration). [If Seller fails to furnish the existing survey or affidavit within 
the  time  prescribed,  ]Buyer shall obtain a new survey at Seller's expense no later than 3 
days  prior  to  Closing  Date if  Seller  fails  to  furnish  within  the  time  prescribed  both  the:  (i)  
existing survey; and (ii) affidavit or declaration. If the Title Company or Buyer’s lender  does 
not  accept  the  existing  survey,  or  the  affidavit  or  declaration,  [is  not  acceptable  to  Title  
...
(2) Within            days after the Effective Date of this contract, Buyer may [shall] obtain a new 
survey  at  Buyer's  expense.  Buyer  is  deemed  to  receive  the  survey  on  the  date  of  actual  
receipt  or  the  date  specified  in  this  paragraph,  whichever  is  earlier.  If  Buyer  fails  to  obtain  
the  survey,  Buyer  may  not  terminate  the  contract  under  Paragraph  2B  of  the  Third  Party  
Financing Addendum because the survey was not obtained.  
...
(12)[(11)]REQUIRED  NOTICES:  The  following  notices  have  been  given  or  are  attached  to  this  
  contract  (for  example,  utility,  water,  drainage,  and  public  improvement  districts  [MUD, 
 WCID, PID notices]):           . 
...
7D(1)  or  (2)  does  not  preclude  Buyer  from  inspecting  the  Property  under  Paragraph  7A,  
from negotiating repairs or treatments in a subsequent amendment, or from terminating this 
...
[11-07-2022] (Address of Property)    
(5) Private transfer fees (as defined by Chapter 5, Subchapter G of the Texas Property Code) will 
be the obligation of Seller unless provided otherwise in this contract. Transfer fees assessed 
by  a  property  owners’  association  are  governed  by  the  Addendum  for  Property  Subject  to  
...
upon closing and funding according 
...
(1) Seller shall pay the following expenses [Expenses payable by Seller] (Seller's Expenses): 
(a) releases [Releases] of existing liens, including prepayment penalties and recording fees; 
release of Seller’s loan liability; tax statements or certificates; preparation of deed; one-
half  of  escrow  fee;  brokerage  fees  that  Seller  has  agreed  to  pay;  and  other  expenses  
payable by Seller under this contract;[.] 
(b) the following amount to be applied to brokerage fees that Buyer has agreed to pay:    
$                          or         _____% of the Sales Price  (check one box only); and  
(c) [Seller shall also pay an] an amount not to exceed $     to  be  applied [in 
the following order: Buyer’s Expenses which Buyer is prohibited from paying by FHA, VA, 
Texas  Veterans  Land  Board  or  other  governmental  loan  programs,  and  then]  to  other  
Buyer’s Expenses [as allowed by the lender]. 
(2) Buyer shall pay the following expenses [Expenses payable by Buyer]  (Buyer's Expenses): 
Appraisal fees; loan application fees; origination charges; credit reports; preparation of loan 
documents; interest on the notes from date of disbursement to one month prior to dates of 
first  monthly  payments;  recording  fees;  copies  of  easements  and  restrictions;  loan  title  
...
premiums for flood and hazard insurance, reserve deposits for insurance, ad valorem taxes 
and  special  governmental  assessments;  final  compliance  inspection;  courier  fee;  repair  
...
Premium  (MIP)  as  required  by  the  lender;  brokerage  fees  that  Buyer  has  agreed  to  pay;  
...
20. FEDERAL [TAX]  REQUIREMENTS: If Seller is a "foreign person,” as defined by Internal Revenue 
Code  and  its  regulations,  or  if  Seller  fails  to  deliver  an  affidavit  or  a  certificate  of  non-foreign  
status  to  Buyer  that  Seller  is  not  a  "foreign  person,”  then  Buyer  shall  withhold  from  the  sales  
proceeds  an  amount  sufficient  to  comply  with  applicable  tax  law  and  deliver  the  same  to  the  
DRAFT
...
(http://www.trec.texas.gov) TREC NO. 20-18[17]. This form replaces TREC NO. 20-17[16]. 
...
agreement between brokers)],  Listing Broker has agreed to pay Other Broker a fee  ( $_______ or   _____% 
of the Sales Price [                                                                                                               ]). This disclosure is for informational purposes and does 
...
Initialed for identification by Buyer                       and Seller            TREC NO. 20-18[17] 
 Contract Concerning                                                                                                                     Page 11 of 11      11-04-2024 
[11-07-2022] (Address of Property)    
